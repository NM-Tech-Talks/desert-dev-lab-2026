...
The following SMEs provided a variety of food & ag problem statements, based on their expertise and community feedback. Four options of the set are provided below. It is encouraged to seek out SME mentors for guidance on fine tuning problem statement ideas and build direction.
